...
#create_clock -add -name sys_clk_pin -period 10.00 -waveform {0 4} [get_ports { sys_clock }];#set
...
## RGB LEDs
#set_property -dict { PACKAGE_PIN L15    IOSTANDARD LVCMOS33 } [get_ports { pulse_ind }]; #IO_L22N_T3_AD7P_35 Sch=LED4_B
...
set_property -dict { PACKAGE_PIN G14    IOSTANDARD LVCMOS33 } [get_ports { pulse_indicator }]; #IO_0_35 Sch=LED5_B
...
## LEDs
#set_property -dict { PACKAGE_PIN R14    IOSTANDARD LVCMOS33 } [get_ports { reset_0 }]; #IO_L6N_T0_VREF_34 Sch=LED0
#set_property -dict { PACKAGE_PIN P14    IOSTANDARD LVCMOS33 } [get_ports { pulse_ind }]; #IO_L6P_T0_34 Sch=LED1
...
## Buttons
#set_property -dict { PACKAGE_PIN D19    IOSTANDARD LVCMOS33 } [get_ports { reset_0 }]; #IO_L4P_T0_35 Sch=BTN0
set_property -dict { PACKAGE_PIN D20    IOSTANDARD LVCMOS33 } [get_ports { pulse_0 }]; #IO_L4N_T0_35 Sch=BTN1
##set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets pulse_0_IBUF]
...
#set_property -dict { PACKAGE_PIN Y17   IOSTANDARD LVCMOS33 } [get_ports { pulse_ind }]; #IO_L7N_T1_34 Sch=JA2_N (Pin 4)
...
set_property -dict { PACKAGE_PIN V5    IOSTANDARD LVCMOS33 } [get_ports { out_to_ESP32 }]; #IO_L6N_T0_VREF_13   Sch=CK_IO27
...
set_property -dict { PACKAGE_PIN V8    IOSTANDARD LVCMOS33 } [get_ports { pulse_in_0 }]; #IO_L15P_T2_DQS_13   Sch=CK_IO32
...
set_property -dict { PACKAGE_PIN F19   IOSTANDARD LVCMOS33 } [get_ports { vauxp12_0 }]; #IO_L15P_T2_DQS_AD12P_35 Sch=AD12_P   ChipKit pin=A6
set_property -dict { PACKAGE_PIN F20   IOSTANDARD LVCMOS33 } [get_ports { vauxn12_0 }]; #IO_L15N_T2_DQS_AD12N_35 Sch=AD12_N   ChipKit pin=A7
