...
################################################################
# This is a generated script based on design: serialtx_pulses_bd
#
...
# source serialtx_pulses_bd_script.tcl


# The design that will be created by this Tcl script contains the following 
# module references:
# eq_dif_model, expo_transf_Z, neutrino_signal, rng_pulse_trigger, serial_tx, signal_mux
...
set design_name serialtx_pulses_bd
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set out_to_ESP32 [ create_bd_port -dir O out_to_ESP32 ]
  set pulse_in_0 [ create_bd_port -dir I pulse_in_0 ]
  set pulse_indicator [ create_bd_port -dir O pulse_indicator ]
  ...
  # Create instance: eq_dif_model_0, and set properties
  set block_name eq_dif_model
  set block_cell_name eq_dif_model_0
  if { [catch {set eq_dif_model_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $eq_dif_model_0 eq "" } {
...
\
  ...
  # Create instance: serial_tx_0, and set properties
  set block_name serial_tx
  set block_cell_name serial_tx_0
  if { [catch {set serial_tx_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $serial_tx_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
    set_property CONFIG.baudrate {1000000} $serial_tx_0
  ...
  connect_bd_net -net Net [get_bd_pins eq_dif_model_0/reset] [get_bd_pins expo_transf_Z_0/reset] [get_bd_pins neutrino_signal_0/reset] [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rng_pulse_trigger_0/reset] [get_bd_pins rst_ps7_0_100M/ext_reset_in] [get_bd_pins serial_tx_0/aresetn]
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_pins axi_gpio_0/gpio_io_o] [get_bd_pins signal_mux_0/SEL]
  connect_bd_net -net eq_dif_model_0_y8 [get_bd_pins eq_dif_model_0/y8] [get_bd_pins signal_mux_0/signal_E]
  connect_bd_net -net expo_transf_Z_0_signalout [get_bd_pins expo_transf_Z_0/signalout] [get_bd_pins signal_mux_0/signal_B]
  connect_bd_net -net neutrino_signal_0_signalout [get_bd_pins neutrino_signal_0/signalout] [get_bd_pins signal_mux_0/signal_C]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk] [get_bd_pins serial_tx_0/clk_zynq]
  connect_bd_net -net pulse_in_0_1 [get_bd_ports pulse_in_0] [get_bd_pins rng_pulse_trigger_0/pulse_in]
  connect_bd_net -net rng_pulse_trigger_0_indicator [get_bd_ports pulse_indicator] [get_bd_pins rng_pulse_trigger_0/indicator]
  connect_bd_net -net rng_pulse_trigger_0_pulse_trig [get_bd_pins eq_dif_model_0/xn] [get_bd_pins expo_transf_Z_0/pulse_trig] [get_bd_pins neutrino_signal_0/pulse_trig] [get_bd_pins rng_pulse_trigger_0/pulse_trig]
  ...
  connect_bd_net -net serial_tx_0_out_tx [get_bd_ports out_to_ESP32] [get_bd_pins serial_tx_0/out_tx]
  connect_bd_net -net serial_tx_0_serial_clk [get_bd_pins eq_dif_model_0/clk] [get_bd_pins expo_transf_Z_0/clk] [get_bd_pins neutrino_signal_0/clk] [get_bd_pins rng_pulse_trigger_0/clk] [get_bd_pins serial_tx_0/serial_clk]
  connect_bd_net -net signal_mux_0_ENABLE [get_bd_pins serial_tx_0/enable_tx] [get_bd_pins signal_mux_0/ENABLE]
  connect_bd_net -net signal_mux_0_S_OUT [get_bd_pins serial_tx_0/dato_tx] [get_bd_pins signal_mux_0/S_OUT]
